require 'feta/mapping_dsl/property_declaration'
require 'feta/mapping_dsl/child_declaration'
require 'feta/mapping_dsl/parser_methods'
require 'feta/mapping_dsl/rdf_subjects'
